...
const ProductDetailPage: React.FC = () => {
      ...
      <div className="min-h-screen bg-slate-950 flex items-center justify-center selection:bg-indigo-500 selection:text-white">
        ...
        <div className="text-center">
          ...
          <button
            ...
            className="px-5 md:px-6 py-2.5 md:py-3 bg-indigo-600 hover:bg-indigo-700 rounded-lg md:rounded-xl font-semibold transition-all text-sm md:text-base"
          >
  ...
  return (
    <div className="min-h-screen bg-slate-950 selection:bg-indigo-500 selection:text-white">
      ...
      <div className="pt-24 md:pt-28 p-4 md:p-6 border-b border-white/10">
        <div className="max-w-6xl mx-auto">
          <button
            onClick={handleBack}
            className="flex items-center gap-2 px-3 md:px-4 py-2 glass rounded-lg md:rounded-xl hover:bg-white/10 transition-all text-sm md:text-base"
          >
      ...
      <div className="max-w-6xl mx-auto p-4 md:p-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
          ...
          {/* Product Details */}
          <div className="glass-dark rounded-2xl md:rounded-3xl p-5 md:p-8 border border-white/10 flex flex-col">
            {/* Icon and Title */}
            <div className="flex items-start gap-3 md:gap-4 mb-4">
              <div className="text-3xl md:text-5xl">{product.icon}</div>
              <div className="flex-1">
                <h1 className="text-xl md:text-3xl font-bold mb-2">
                  {language === 'ar' ? product.title_ar : product.title_en}
                </h1>
                {product.category && (
                  <span className="inline-block px-2 md:px-3 py-1 text-xs md:text-sm bg-indigo-600/20 text-indigo-300 rounded-full">
                    {product.category}
                  </span>
                )}
              </div>
            ...
            <div className="mb-5 md:mb-6 flex-1">
              <h3 className="text-base md:text-lg font-semibold mb-2 text-slate-300">
            ...
            {showPrice ? (
              ...
              <div className="mb-5 md:mb-6">
                <div className="text-base md:text-lg text-amber-400 flex items-center gap-2">
            ...
            <button
              ...
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 md:py-4 rounded-lg md:rounded-xl font-semibold transition-all flex items-center justify-center gap-2 text-sm md:text-base"
            >
